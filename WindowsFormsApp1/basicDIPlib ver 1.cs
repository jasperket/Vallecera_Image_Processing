    ...
    static class ImageProcess
    {
        ...
        public static void greyScale(ref Bitmap a, ref Bitmap b)
        {
            ...
            for (int x = 0; x < a.Width; x++)
            {
                for (int y = 0; y < a.Height; y++)
                {
                    ...
                    b.SetPixel(x, y, Color.FromArgb(grey, grey, grey));
                }
        ...
        public static void colorInversion(ref Bitmap a, ref Bitmap b)
        {
            ...
            for (int x = 0; x < a.Width; x++)
            {
                ...
                {
                    Color data = a.GetPixel(x, y);
                    b.SetPixel(x, y, Color.FromArgb(255-data.R,255-data.G,255-data.B));
                }
        ...
        public static void sepia(ref Bitmap a, ref Bitmap b)
        {
            ...
            for (int x = 0; x < a.Width; x++)
            {
                ...
                {
                    Color data = a.GetPixel(x, y);
                    int greyValue = (data.R + data.G + data.B) / 3;
                    ...
                    b.SetPixel(x, y, Color.FromArgb(sepiaR,sepiaG,sepiaB));
                }
